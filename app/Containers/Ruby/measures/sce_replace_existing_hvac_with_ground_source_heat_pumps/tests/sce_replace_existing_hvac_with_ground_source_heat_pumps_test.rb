...
class SCEReplaceExistingHVACWithGroundSourceHeatPumpsTest < Minitest::Test
  # def setup
  # end
  ...
  def skip_test_number_of_arguments_and_argument_names
    # create an instance of the measure
    measure = SCEReplaceExistingHVACWithGroundSourceHeatPumps.new
    ...
    assert_equal('cool_cop', arguments[6].name)
    assert_equal('heat_cop', arguments[7].name)
  end

  def skip_test_bad_argument_values
    args = {}
  ...
  def skip_test_and_run_zone_hps
  ...
  def test_university_building
    test_name = (__method__).to_s
    osm_path = File.dirname(__FILE__) + '/University Building_alternative_13.osm'
