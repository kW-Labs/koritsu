  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-6 card pb-5 wrap">
        <h2 class="pb-3 pt-4">Update Project</h2>
...
export default {
  ...
  methods: {
    ...mapActions({
      updateProjectAction: "auth/updateProject",
      getProjectAction: "auth/getProject"
    }),
    ...
    setDefault() {
      ...
      this.getProjectAction(this.id).then((project) => {
        const schema_data = JSON.parse(project.data)
    ...
    onSubmit() {
      ...
      this.updateProjectAction({id: this.id, data: {name: this.form.project_name, data: this.form}})
          .then((response) => {
