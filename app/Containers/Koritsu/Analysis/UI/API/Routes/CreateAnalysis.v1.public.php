...
/**
 * @apiGroup           Analyses
 * @apiName            createAnalysis
 *
 * @api                {POST} /v1/projects/:id/analyses/create Creates an Analysis
 * @apiDescription     Create a new base analysis to a Project using the logged-in user, then dispatch the Open Studio Baseline Analysis Job Flow.
...
Route::post('projects/{id}/analyses/create', [Controller::class, 'createAnalysis'])
    ->name('api_create_analysis')
    ->middleware(['auth:api']);
